  ...
  const handleSignUp = (e) => {
    ...
    if (checked) {
      ...
      if (
        ...
        setSuccessMsg(
          `Hello dear ${clientName}, Welcome you to Desi-Courier Admin panel. We received your Sign up request. We are processing to validate your access. Till then stay connected and additional assistance will be sent to you by your mail at ${email}`
        )
        setClientName('')
        setEmail('')
        setPhone('')
          ...
          <div className='w-[300px] flex items-start gap-3'>
            ...
            <p className='text-base text-gray-300'>
              <span className='text-white font-semibold font-titleFont'>
                Get started fast with Desi Couriers
              </span>
              <br />
              Bring happiness to the people how are missing home!
            </p>
          </div>
          <div className='w-[300px] flex items-start gap-3'>
            <span className='text-green-500 mt-1'>
            ...
            <p className='text-base text-gray-300'>
              <span className='text-white font-semibold font-titleFont'>
                Access all Desi Couriers services
              </span>
              <br />
